...
We combined two methods to be able visually explore topics and words' connections in the aims and missions documents.
...
The three primary steps were followed: 
...
# Below chunk contain functions which were used to create words similarities matrix. Source of the code: 
...
# Running above functions for each stakeholder seperately
