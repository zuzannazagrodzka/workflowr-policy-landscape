...
This script creates a figure ilustrating what journals are owned by the societies or different institutions (other) and journals owned and run only by publishers.
...
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
  ...
  labs(y= "Frequency", x = "Category of journal")
  

head(data_journals, 5)
