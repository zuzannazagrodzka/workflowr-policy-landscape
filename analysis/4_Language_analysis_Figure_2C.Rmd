...
Application of text analyses to reveal association between stakeholders and Open Research (UNESCO) and business language. The code below includes control (book). We decided to keep only words that are unique for each of the dictionary. 
It will enable us see the association and the divergence across the documents. We plotted the percentage of words that documents in the stakeholders groups share with the created by us dictionaries. 
...
Meaning of the columns in the final dataframe: 
